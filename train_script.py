...
MAIN_EXPERIMENT_NAME = 'nasimemu-medium-autotune-original-encoding-with-postion-feats-h-param-sweep-critic-lr'
NUM_RUNS = 1
...
if __name__ == '__main__':
    ...
    train_hyper_param('critic_lr', [.005, .001, .0005], [0, 1, 2])
