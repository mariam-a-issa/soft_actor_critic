...
MAIN_EXPERIMENT_NAME = 'nasimemu-medium-autotune-normalize-bundle-encoding-with-permutation-h-param-sweep-critic-lr'
NUM_RUNS = 1
...
if __name__ == '__main__':
    ...
    train_hyper_param('critic_lr', [.001, .005, .0005], [0, 1, 2])
