...
OTHER_HPARAMS = { #Just the default params that may be different than the ones in the training file
    ...
    'learning_steps' : 1,
    'update_frequency' : 1,
    'environment_info' : {'id' : 'NASimEmu-v0', 'emulate' : False, 'scenario_name' : '/home/mariamai/projects/hd_sac/NASimEmu/scenarios/corp.v2.yaml'},
    'max_steps' : 200000,
    'eval_frequency' : 10,
    'num_evals' : 5,
    'tensorboard' : True,
...
if __name__ == '__main__':
    ...
    train_hyper_param('alpha_value', [.15, .2], [0, 1, 2, 3, 4])
